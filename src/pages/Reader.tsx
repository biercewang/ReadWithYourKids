        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 group">
          ...
          >
            ...
            <button
              ...
              className="w-9 h-9 inline-flex items-center justify-center hover:scale-105 active:scale-95 focus:outline-none"
              style={{ backgroundColor: 'transparent', color: (() => { const active = readerTheme === 'yellow' ? '#F59E0B' : readerTheme === 'green' ? '#22C55E' : readerTheme === 'blackWhite' ? '#FFFFFF' : '#374151'; const inactive = readerTheme === 'blackWhite' ? '#F3F4F6' : '#374151'; return ((isPlaying || isTtsPending) || hoverBottomTts) ? active : inactive })() }}
            >
              {isPlaying ? (
